ASM_SRC = kernel.asm
LINK_LD = linker.ld
C_SRC = math/math.c string/string.c keyboard/keyboard.c screen/screen.c kernel.c
TARGET = kernel
ASM_O = kasm.o
C_O = $(OBJS_DIR)/screen.o $(OBJS_DIR)/kc.o $(OBJS_DIR)/keyboard.o $(OBJS_DIR)/string.o $(OBJS_DIR)/math.o
OBJS_DIR = objects
